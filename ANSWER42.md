...
Answer42 даёт агенту инструменты `start_session`, `open_navigation_link`, `click_button`, `ui_tree` и другие: открывать управляемые формы 1С, нажимать кнопки, заполнять поля.
